function filename_list=bar_video_3comparsion_rescaled_ratio_fixed_resolution_script

clear all
close all

video_name = 'CG_bar_Y10000_neo-hookean_rescaled_ratio_fixed_resolution_ERE.avi';
...
%% first comparision
filename_list{1} = 'sim_data\simulation3D_deform_full_ERE_rescaled_ratio_fixed_bar26_neo-hookean_small_bar\ERE_CG_constraint_n_h0.48_Y10000_P0.45_rho1000_a0_b0.02_dt0.01_def-scln_redu20\trajectory.mat';

%% first comparision

filename_list{2} = 'sim_data\simulation3D_deform_full_ERE_rescaled_ratio_fixed_bar26_neo-hookean_small_bar\ERE_CG_constraint_n_h0.3_Y10000_P0.45_rho1000_a0_b0.02_dt0.01_def-scln_redu20\trajectory.mat';


%% second comparison

filename_list{3} = 'sim_data\simulation3D_deform_full_ERE_rescaled_ratio_fixed_bar26_neo-hookean_small_bar\ERE_CG_constraint_n_h0.2_Y10000_P0.45_rho1000_a0_b0.02_dt0.01_def-scln_redu20\trajectory.mat';
