function filename_list=bar_video_4comparsion_DAC_polyfit_script

clear all
close all

video_name = 'CG_bar_Y6000_neo-hookean_DAC_polyfit_short.avi';
...
filename_list{1} = 'sim_data\simulation3D_motions_bar_polyfit_neo-hookean_small_bar\IM_CG_constraint_n_h0.5_Y6000_P0.45_rho1000_a1_b0.01_dt0.01_def-scln\trajectory.mat';


%% second comparison

filename_list{2} = 'sim_data\simulation3D_motions_bar_DAC_neo-hookean_small_bar\IM_CG_constraint_n_h0.5_Y6000_P0.45_rho1000_a1_b0.01_dt0.01_def-scln\trajectory.mat';


%% third comparison
filename_list{3} = 'sim_data\simulation3D_motions_bar_neo-hookean_small_bar\IM_CG_constraint_n_h0.5_Y6000_P0.45_rho1000_a1_b0.01_dt0.01_def-scln\trajectory.mat';

%% fourth comparison
filename_list{4} = 'sim_data\simulation3D_motions_bar_neo-hookean_small_bar\IM_CG_constraint_n_h0.2_Y6000_P0.45_rho1000_a1_b0.01_dt0.01_def-scln\trajectory.mat';
