function name = simulation3D_motions_bar_polyfit_modK(varargin)
close all
clf
...
if (exist([simdir fs 'trajectory.mat'], 'file') ~= 2)
    ...
    for ti = 1:tsteps
        ...
        switch solver
            case 'IM'
                u = polyfit_ImplicitMid_modK(dt, u, obj,~indLogical);
            case 'SI'
                u = polyfit_SemiImplicit_modK(dt, u, obj,~indLogical);
            case 'SIModified'
            ...
            case 'ERE'
                u = polyfit_ERE_modK(dt, u, obj, ~indLogical);
            case 'BE'
                u = polyfit_BackwardEuler_modK(dt, u, obj, ~indLogical);
            case 'IMIMEX'
