...
meshfiles = {'horsemesh5','horsemesh7'};
...
%                     
%             end
%             elseif any(strfind(filename,'horse'))
%             switch i_filename
%                 
%                 case 1
...
%                     positions(3:3:end) = positions(3:3:end) + 0.24;
%                 case 2
%                     positions(1:3:end) = positions(1:3:end) + 0.4;
%                     %                         positions(2:3:end) = positions(2:3:end) - 0.2;
%                     positions(3:3:end) = positions(3:3:end) + 0.24;
%                 case 3
%                     positions(1:3:end) = positions(1:3:end) + 0.35;
...
%                 campos([    -3.7619   19.0305    1.1623]);
%                 camtarget([     0.0092    0.0030    0.2347])
%                 camup([0.0093   -0.0469    0.9989])
%             end
%             %                 campos([0    2.0   2]);
