...
function filename_list=armadillo_hete_video_2comparsion_rescaled_resolution_script

clear all
close all

video_name = 'CG_armadillo_hete_Y800000_stvk_not_rescaled_resolution_SI_long.avi';
...
filename_list{1} = '/Users/edwinchen/Dropbox/adobe_internship(Selective Sync Conflict)/hyperbolicFE/sim_data/simulation3D_full_SI_not_rescaled_moving_coarsearmadillo_hete6_stvk_coarsearmadillo/SI_CG_constraint_n_h1_Y800000_P0.45_rho1000_a0_b0_dt0.01/trajectory.mat';


%% second comparison

filename_list{2} = '/Users/edwinchen/Dropbox/adobe_internship(Selective Sync Conflict)/hyperbolicFE/sim_data/simulation3D_full_SI_not_rescaled_moving_armadillo_hete6_stvk_armadillo/SI_CG_constraint_n_h1_Y800000_P0.45_rho1000_a0_b0_dt0.01/trajectory.mat';
