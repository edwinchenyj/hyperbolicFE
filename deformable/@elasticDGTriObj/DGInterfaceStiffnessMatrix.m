...
%                         B = [0 0]';
                        f = Len*(A(1,1)/3 * (P1(1)*P1(1) + P1(1) * P0(1) + P0(1) * P0(1))...
                            +A(2,2)/3 * (P1(2)*P1(2) + P1(2) * P0(2) + P0(2) * P0(2))...
                            +( A(1,2) + A(2,1) ) * ( 1/6 * P0(1) * P1(2) + 1/6 * P0(2) * P1(1) + 1/3 * P1(1)*P1(2) + 1/3 * P0(1) * P0(2))...
                            + (B(1)*P0(1) + B(2)*P0(2) + 1/2 * B(1)*(P1(1) - P0(1)) + 1/2 * B(2) * (P1(2) - P0(2)))...
                            + ((obj.I2(:,j) * bary(i) - obj.I2(:,j)*obj.G(i,:)*D_minus * obj.DGnodeM(verts_minus(1),:)')' * (obj.I2(:,l) * bary(k) - obj.I2(:,l)*obj.G(k,:)*D_minus * obj.DGnodeM(verts_minus(1),:)'))...
...
%                         B = [0 0]';
                        f = Len*(A(1,1)/3 * (P1(1)*P1(1) + P1(1) * P0(1) + P0(1) * P0(1))...
                            ...
                            +( A(1,2) + A(2,1) ) * ( 1/6 * P0(1) * P1(2) + 1/6 * P0(2) * P1(1) + 1/3 * P1(1)*P1(2) + 1/3 * P0(1) * P0(2))...
                            + (B(1)*P0(1) + B(2)*P0(2) + 1/2 * B(1)*(P1(1) - P0(1)) + 1/2 * B(2) * (P1(2) - P0(2)))...
                            - (obj.I2(:,j) * bary(i) - obj.I2(:,j)*obj.G(i,:)*D_minus * obj.DGnodeM(verts_minus(1),:)')' * (obj.I2(:,l) * bary(k) - obj.I2(:,l)*obj.G(k,:)*D_plus * obj.DGnodeM(verts_plus(1),:)')...
...
%                         B = [0 0]';
                        f = Len*(A(1,1)/3 * (P1(1)*P1(1) + P1(1) * P0(1) + P0(1) * P0(1))...
                            ...
                            +( A(1,2) + A(2,1) ) * ( 1/6 * P0(1) * P1(2) + 1/6 * P0(2) * P1(1) + 1/3 * P1(1)*P1(2) + 1/3 * P0(1) * P0(2))...
                            + (B(1)*P0(1) + B(2)*P0(2) + 1/2 * B(1)*(P1(1) - P0(1)) + 1/2 * B(2) * (P1(2) - P0(2)))...
                            - (obj.I2(:,j) * bary(i) - obj.I2(:,j)*obj.G(i,:)*D_plus * obj.DGnodeM(verts_plus(1),:)')' * (obj.I2(:,l) * bary(k) - obj.I2(:,l)*obj.G(k,:)*D_minus * obj.DGnodeM(verts_minus(1),:)')...
...
%                         B = [0 0]';
                        f = Len*(A(1,1)/3 * (P1(1)*P1(1) + P1(1) * P0(1) + P0(1) * P0(1))...
                            ...
                            +( A(1,2) + A(2,1) ) * ( 1/6 * P0(1) * P1(2) + 1/6 * P0(2) * P1(1) + 1/3 * P1(1)*P1(2) + 1/3 * P0(1) * P0(2))...
                            + (B(1)*P0(1) + B(2)*P0(2) + 1/2 * B(1)*(P1(1) - P0(1)) + 1/2 * B(2) * (P1(2) - P0(2)))...
                            + (obj.I2(:,j) * bary(i) - obj.I2(:,j)*obj.G(i,:)*D_plus * obj.DGnodeM(verts_plus(1),:)')' * (obj.I2(:,l) * bary(k) - obj.I2(:,l)*obj.G(k,:)*D_plus * obj.DGnodeM(verts_plus(1),:)')...
