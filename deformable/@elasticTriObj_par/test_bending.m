...
hfun_list = [1 0.5 0.2 0.1 0.05 0.01]'; % list of target edge length, the parameter to change mesh resolution
...
Xind_fix = nodeM(:,1) == 0; % logical indices for x
