function name = simulation3D_all_def_reduced_ERE_rescaled_bar(varargin)
close all
clf
...
loaddir = sprintf('sim_data%csimulation3D_rotate_less_reduced_ERE_bar_%s_%s', fs,material_type, mesh_shape);
simdir = strcat(loaddir,fs,solver,'_',simulation_type,...
...
twisting = load([simdir fs 'trajectory.mat']); % storing eigen decomp
