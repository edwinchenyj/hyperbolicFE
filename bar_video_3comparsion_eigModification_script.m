function filename_list=bar_video_3comparsion_eigModification_script

clear all
close all

video_name = 'CG_bar_Y10000_neo-hookean_reduced_ERE.avi';
...
filename_list{1} = 'sim_data\simulation3D_reduced_ERE_bar6_neo-hookean_small_bar\ERE_CG_constraint_n_h0.3_Y10000_P0.45_rho1000_a0_b0.01_dt0.01_def-scln_redu20\trajectory.mat';


%% second comparison

filename_list{2} = 'sim_data\simulation3D_not_reduced_ERE_bar6_neo-hookean_small_bar\ERE_CG_constraint_n_h0.3_Y10000_P0.45_rho1000_a0_b0.01_dt0.01_def-scln\trajectory.mat';


%% third comparison
filename_list{3} = 'sim_data\simulation3D_not_reduced_ERE_bar6_neo-hookean_small_bar\ERE_CG_constraint_n_h0.2_Y10000_P0.45_rho1000_a0_b0.01_dt0.01_def-scln\trajectory.mat';
