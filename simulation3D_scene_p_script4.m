...
meshfiles = {'bunnymesh1','bunnymesh2','bunnymesh3','bunnymesh4','bunnymesh5'};
% meshfiles = {'small_bar_h_4.80e-01','small_bar_h_2.50e-01','small_bar_h_2.00e-01'};
meshfiles = {'bunnymesh4','bunnymesh5'};
parameter_lists = {...
    'dt',[1/100],...
    'T',[3],...
...
%%
colors = [bone(3); summer(3); bone(3); copper(3)];
...
%                     positions(3:3:end) = positions(3:3:end) + 0.24;
            ...
            elseif any(strfind(filename,'torusmesh'))
                switch i_filename
...
%             h{i_filename}.FaceAlpha = 0.3;
            ...
            campos([1.1030  -16.6271   -0.0225]);
            camtarget([ 1.1030    0.2880   -0.1534]);
            ...
            elseif any(strfind(meshfiles{1},'horse'))
                ...
                camva(6.9295);
                camup([0 0 1]);
            elseif any(strfind(meshfiles{1},'torusmesh'))
                campos([-19.4643  -14.3324    4.4986]);
                camtarget([ -0.0246    0.0000    0.2399])
            elseif any(strfind(meshfiles{1},'bunnymesh'))
                campos([-18.5456  -17.3622   -0.4132]);
                camtarget([0.1083    0.0329    0.4775]);
