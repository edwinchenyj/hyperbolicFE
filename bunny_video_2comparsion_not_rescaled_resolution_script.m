function filename_list=bunny_video_2comparsion_not_rescaled_resolution_script

clear all
close all

video_name = 'CG_bunny_Y700_stvk_not_rescaled_resolution_SI.avi';
...
filename_list{1} = 'sim_data/simulation3D_jump_SI_not_rescaled_vcoarsebunny_hete_stvk6/SI_CG_constraint_n_h0.5_Y3000_P0.45_rho1000_a0_b0_dt0.01_def-scln/trajectory.mat';


%% second comparison

filename_list{2} = 'sim_data/simulation3D_jump_SI_not_rescaled_scoarsebunny_hete_stvk6/SI_CG_constraint_n_h0.5_Y3000_P0.45_rho1000_a0_b0_dt0.01_def-scln/trajectory.mat';
