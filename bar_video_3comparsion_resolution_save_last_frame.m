function filename_list=bar_video_3comparsion_resolution_save_last_frame

clear all
close all

pname = 'CG_bar_Y10000_neo-hookean_not_rescaled_resolution';
...
%% first comparision
filename_list{1} = 'sim_data\simulation3D_deform_full_SI_not_rescaled_bar26_neo-hookean_small_bar\SI_CG_constraint_n_h0.33333_Y10000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20\trajectory.mat';

%% first comparision

filename_list{2} = 'sim_data\simulation3D_deform_full_SI_not_rescaled_bar26_neo-hookean_small_bar\SI_CG_constraint_n_h0.25_Y10000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20\trajectory.mat';


%% second comparison

filename_list{3} = 'sim_data\simulation3D_deform_full_SI_not_rescaled_bar26_neo-hookean_small_bar\SI_CG_constraint_n_h0.2_Y10000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20\trajectory.mat';
...
%                 whitebg(cmap)
                ...
                campos([-1.4392    1.7092    1.0968]);
                camtarget([ 0.1108   -0.0864    0.2131])
%                 campos([0    2.0   2]);
