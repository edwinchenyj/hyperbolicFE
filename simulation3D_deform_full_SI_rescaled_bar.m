function name = simulation3D_deform_full_SI_rescaled_bar(varargin)
close all
clf
...
traj_name = ['sim_data' fs 'simulation3D_rotate_full_SI_rescaled_bar_',...
    material_type,'_small_bar' fs 'SI_CG_constraint_n_h',num2str(h),'_Y10000_P0.45_rho1000_a0_b0_dt0.01_def-scln' fs 'trajectory.mat'];
% 
