...
filename_list{1} = '/Users/yujuedwinchen/Dropbox/adobe_internship/hyperbolicFE/sim_data/simulation3D_full_SI_not_rescaled_moving_coarsearmadillo_hete6_stvk_coarsearmadillo/short/SI_CG_constraint_n_h1_Y800000_P0.45_rho1000_a0_b0_dt0.01/trajectory.mat';


%% second comparison

filename_list{2} = '/Users/yujuedwinchen/Dropbox/adobe_internship/hyperbolicFE/sim_data/simulation3D_full_SI_not_rescaled_moving_armadillo_hete6_stvk_armadillo/short/SI_CG_constraint_n_h1_Y800000_P0.45_rho1000_a0_b0_dt0.01/trajectory.mat';
...
%             sky = surf(scal*(skyX-offc),scal*(skyY-offc),scal*(skyZ-offc),'LineStyle','none','FaceColor','flat','FaceLighting','gouraud'); %Make a sphere object.
            ...
            for i_filename = 1:length(trajectories)
                ...
                switch i_filename
                    case 1
                        positions(1:3:end) = positions(1:3:end) +1;
...
%                 whitebg(cmap)
                ...
                campos([    1.9259  -20.8837    5.3614]);
                camtarget([0.2341   -0.6880    0.9054])
%                 campos([0    2.0   2]);
