function name = simulation3D_rotate_reduced_extended_ERE_bar(varargin)
close all
clf
...
left_transform = [1 0 0 0; 0 1 0 -1/6/5; 0 0 1 -1/6/5; 0 0 0 1];
inv_left_transform = [1 0 0 0; 0 1 0 1/6/5; 0 0 1 1/6/5; 0 0 0 1];

right_transform = [1 0 0 0; 0 1 0 -1/6/5; 0 0 1 -1/6/5; 0 0 0 1];
inv_right_transform = [1 0 0 0; 0 1 0 1/6/5; 0 0 1 1/6/5; 0 0 0 1];
...
if (exist([simdir fs 'trajectory.mat'], 'file') ~= 2)
    ...
    for ti = 1:tsteps
        ...
        switch solver
            ...
            case 'ERE'
                u = reduced_extended_ERE(dt, u, obj, ~indLogical);
            case 'BE'
...
%                 obj.patch_handle.FaceVertexCData = repmat([0.9100 0.4100 0.1700],N,1);
                obj.patch_handle.FaceVertexCData = repmat([0.8 0.9 1],N,1);
