function filename_list=bar_droop_video_3comparsion_not_rescaled_resolution_script

clear all
close all

video_name = 'CG_bar_droop_Y1000_neo-hookean_not_rescaled_resolution_SI.avi';
