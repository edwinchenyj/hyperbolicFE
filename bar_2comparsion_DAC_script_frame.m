function filename_list=bar_2comparsion_DAC_script_frame

clear all
close all

pname = 'bar_neo-hookean_DAC';
...
filename_list{1} = 'sim_data/simulation3D_motions_bar_DAC_neo-hookean_small_bar/SI_CG_constraint_n_h0.3_Y4000_P0.3_rho1000_a0_b0_dt0.01_def-scln/trajectory.mat';


%% second comparison

filename_list{2} = 'sim_data/simulation3D_motions_bar_DAC_neo-hookean_small_bar/SI_CG_constraint_n_h0.2_Y4000_P0.3_rho1000_a0_b0_dt0.01_def-scln/trajectory.mat';


%%
colors = [bone(3); copper(3)];
...
%             sky = surf(scal*(skyX-offc),scal*(skyY-offc),scal*(skyZ-offc),'LineStyle','none','FaceColor','flat','FaceLighting','gouraud'); %Make a sphere object.
            ...
            for i_filename = 1:length(trajectories)
                ...
                switch i_filename
                    ...
                    case 2
                        positions(2:3:end) = positions(2:3:end) - 0;
                        positions(3:3:end) = positions(3:3:end) + 0.24;
%                     case 3
...
%                 whitebg(cmap)
                ...
                campos([-2.1606   -0.1300    1.9364]);
                camtarget([0.1378   -0.1300    0.1897])
%                 campos([0    2.0   2]);
