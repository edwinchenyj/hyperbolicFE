...
for i_eig_modes = 1:length(eig_modes_list)
    eig_modes = eig_modes_list(i_eig_modes);
                                            %                                              
...
%                                             eval(expression);
simulation3D_full_SI_rescaled_moving_coarsearmadillo_hete('draw',draw,...
