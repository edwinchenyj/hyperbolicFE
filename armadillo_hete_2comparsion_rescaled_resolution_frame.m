function filename_list=armadillo_hete_2comparsion_rescaled_resolution_frame

clear all
close all

pname = 'armadillo_hete_rescaled';
...
filename_list{1} = '/Users/yujuedwinchen/Dropbox/adobe_internship/hyperbolicFE/sim_data/simulation3D_full_SI_rescaled_moving_coarsearmadillo_hete6_stvk_coarsearmadillo/SI_CG_constraint_n_h1_Y800000_P0.45_rho1000_a0_b0_dt0.01/trajectory.mat';


%% second comparision

filename_list{2} = '/Users/yujuedwinchen/Dropbox/adobe_internship/hyperbolicFE/sim_data/simulation3D_full_SI_rescaled_moving_armadillo_hete6_stvk_armadillo/SI_CG_constraint_n_h1_Y800000_P0.45_rho1000_a0_b0_dt0.01/trajectory.mat';
...
%             sky = surf(scal*(skyX-offc),scal*(skyY-offc),scal*(skyZ-offc),'LineStyle','none','FaceColor','flat','FaceLighting','gouraud'); %Make a sphere object.
            ...
            for i_filename = 1:length(trajectories)
                ...
                switch i_filename
                    case 1
                        positions(1:3:end) = positions(1:3:end) +0.8;
