...
function filename_list=armadillo_video_2comparsion_not_rescaled_resolution_script

clear all
close all

video_name = 'CG_armadillo_hete_Y200000_stvk_not_rescaled_resolution_SI.avi';
...
filename_list{1} = 'sim_data\simulation3D_full_SI_not_rescaled_moving_coarsearmadillo_hete6_stvk_coarsearmadillo\SI_CG_constraint_n_h1_Y200000_P0.45_rho1000_a0_b0_dt0.01\trajectory.mat';


%% second comparison

filename_list{2} = 'sim_data\simulation3D_full_SI_not_rescaled_moving_armadillo_hete6_stvk_armadillo\SI_CG_constraint_n_h1_Y200000_P0.45_rho1000_a0_b0_dt0.01\trajectory.mat';



%%

edge_colors = num2cell(hsv(2),2); % create a list of different colours
...
%                         positions(1:3:end) = positions(1:3:end) - 0.01;
                        positions(2:3:end) = positions(2:3:end) - 1;
...
%                 whitebg(cmap)
                ...
                campos([   -9.6244  -10.0722    3.8227]);
                camtarget([-0.2079   -0.7250   -0.0946+1])
%                 campos([0    2.0   2]);
