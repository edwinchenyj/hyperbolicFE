...
%             camtarget([-3.3552    0.2523   -0.3765]);
            campos([1.0000  -15.1505   -0.2496-0.01]);
            camtarget([1.0000   -0.1701   -0.2496-0.01]);
...
%             campos([-3.3552  -23.0902   -0.3762]);
%             camtarget([-3.3552    0.2523   -0.3765]);
            campos([-14.7516   -7.2674   -1.8402]);
            camtarget([0.4553   -0.1764   -0.0766]);
