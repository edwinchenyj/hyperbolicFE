function name = simulation3D_deform_full_SI_not_rescaled_bar3_hete(varargin)
close all
clf
...
if (exist([simdir fs 'trajectory.mat'], 'file') ~= 2)
    ...
    soft_points = find(abs(nodeM(:,1)-1/5) < 1/5/3);
