...
f_input = [];
for i_para = 1:length(parameter_lists)/2
    f_input = strcat(f_input,num2str(parameter_lists{i_para}));
    i_para = i_para + 1;
...
%                                             eval(expression);
simulation3D_deform_full_SI_not_rescaled_bar3_hete('draw',draw,...
