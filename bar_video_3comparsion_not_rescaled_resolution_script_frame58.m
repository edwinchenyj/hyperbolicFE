function filename_list=bar_video_3comparsion_not_rescaled_resolution_script_frame58

clear all
close all

video_name = 'CG_bar_Y10000_neo-hookean_not_rescaled_resolution_SI.avi';
...
%% first comparision
filename_list{1} = 'sim_data\simulation3D_deform_full_SI_not_rescaled_bar26_neo-hookean_small_bar\SI_CG_constraint_n_h0.48_Y10000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20\trajectory.mat';

%% first comparision

filename_list{2} =     'sim_data\simulation3D_deform_full_SI_not_rescaled_bar26_neo-hookean_small_bar\SI_CG_constraint_n_h0.3_Y10000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20\trajectory.mat';
...
%                 whitebg(cmap)
                ...
                campos([-0.7194    6.0120    2.1908]);
                camtarget([0.2211   -0.0631    0.0941]);
%                 campos([0    2.0   2]);
