function filename_list=subspace_vs_fullspace_small_def

clear all
close all

pname = 'subspace_vs_fullspace_small_def';
...
%% first comparision
filename_list{1} = '/Users/yujuedwinchen/Dropbox/adobe_internship/hyperbolicFE/sim_data/simulation3D_not_reduced_ERE_bar6_neo-hookean_small_bar/ERE_CG_constraint_n_h0.3_Y10000_P0.45_rho1000_a0_b0.01_dt0.01_def-scln/trajectory.mat';

%% second comparison

filename_list{2} = '/Users/yujuedwinchen/Dropbox/adobe_internship/hyperbolicFE/sim_data/simulation3D_reduced_ERE_rescaled_bar6_neo-hookean_small_bar/ERE_CG_constraint_n_h0.3_Y10000_P0.45_rho1000_a0_b0.01_dt0.01_def-scln_redu20/trajectory.mat';


%%
colors = [cool(3); spring(3); summer(3); autumn(3); winter(3)];
...
%             sky = surf(scal*(skyX-offc),scal*(skyY-offc),scal*(skyZ-offc),'LineStyle','none','FaceColor','flat','FaceLighting','gouraud'); %Make a sphere object.
            ...
            for i_filename = 1:length(trajectories)
                ...
                switch i_filename
                    case 1
                        positions(1:3:end) = positions(1:3:end);
...
%                 whitebg(cmap)
                ...
                campos([0.2270    2.7898    4.6175]);
                camtarget([0.1798   -0.0324    4.0088]);
%                 campos([0    2.0   2]);
