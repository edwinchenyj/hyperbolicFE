...
meshfiles = {'flatTorusmesh1','flatTorusmesh2','flatTorusmesh3'};
...
%                     positions(3:3:end) = positions(3:3:end) + 0.24;
            ...
            elseif any(strfind(meshfiles{1},'flatTorusmesh'))
                campos([-3.6534   -9.9710    4.3556]);
                camtarget([  -0.0244   -0.0004    0.2400])
