function filename_list=bar_video_3comparsion_rescaled_resolution_script

clear all
close all

video_name = 'CG_bar3_hete_Y700000_neo-hookean_rescaled_resolution_SI.avi';
...
%% first comparision
filename_list{1} =     'sim_data/simulation3D_deform_full_SI_rescaled_bar3_hete6_neo-hookean_small_bar/SI_CG_constraint_n_h0.48_Y700000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20/trajectory.mat'

%% first comparision

filename_list{2} =     'sim_data/simulation3D_deform_full_SI_rescaled_bar3_hete6_neo-hookean_small_bar/SI_CG_constraint_n_h0.3_Y700000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20/trajectory.mat';


%% second comparison

filename_list{3} =     'sim_data/simulation3D_deform_full_SI_rescaled_bar3_hete6_neo-hookean_small_bar/SI_CG_constraint_n_h0.2_Y700000_P0.45_rho1000_a0_b0_dt0.01_def-scln_redu20/trajectory.mat';
...
%%
colors = [summer(6); bone(6); copper(6)];
